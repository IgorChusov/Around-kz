    ...
    <div className={styles.container}>
      ...
      <ul className={styles.list}>
        {user.data.businessman.map((elem) => (
          ...
          <Link className={styles.link} to={`/menu/account/myQuestionnaires/${elem.questionnaire_type.toLowerCase()}/${elem.id}`}></Link>
          </li>
        )) }
        <li className={styles.item}>
          ...
          <Link className={styles.link} to={'/menu/account/createServices/selection'} />
        </li>
      </ul>
      <Menu />
    </div>
