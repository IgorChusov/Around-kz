...
export function AccountMenuQuestionnairePage () {
  ...
  return (
    <div className={styles.container}>
      ...
      {hasLoading && (
        <>
          <ButtonBack addressLink="/account/myQuestionnaires" />
          ...
          <ul className={styles.list}>
            ...
            <li className={styles.item}>
              ...
              <Link
                ...
                to={
                  typeService === 'service'
                    ? `/account/myQuestionnaires/${typeService}/${id}/changeInfo`
                    : `/account/myQuestionnaires/products/${id}/changeInfo`
                }
              ></Link>
            </li>
            <li className={styles.item}>
              ...
              <Link
                ...
                to={
                  typeService === 'service'
                    ? `/account/myQuestionnaires/${typeService}/${id}/changeInfo/components`
                    : `/account/myQuestionnaires/products/${id}/changeInfo/listProduct`
                }
              ></Link>
            </li>
            <li className={styles.item}>
              ...
              <Link
                className={styles.link}
                to={`/account/myQuestionnaires/${typeService}/${id}/changePay`}
              ></Link>
            </li>
            <li className={styles.item}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <Link className={styles.link} to={`/account/myQuestionnaires/${typeService}/${id}/schedule`} />
            </li>
          </ul>
