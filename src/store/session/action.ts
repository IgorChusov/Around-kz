...
export const RegisterUserAsync = (data: { phone: string, username: string }): ThunkAction<void, RootState, unknown, Action<string>> => 
  async (dispatch) => {
...
export const RegisterSmsActivateAsync = (phone: string, username: string, code: string, coordinates: [number, number] ): ThunkAction<void, RootState, unknown, Action<string>> =>
 async (dispatch) => {
    dispatch(registerRequest())
    try {
...
export const LoginSmsActivateAsync = (phone: string, code: string): ThunkAction<void, RootState, unknown, Action<string>> =>
  (dispatch) => {
    dispatch(registerRequest())
...
export const RefreshTokenAsync = (): ThunkAction<void, RootState, unknown, Action<string>> =>
  async (dispatch) => {
    try {
      dispatch(registerRequest())
